...
#task 0 is LDT 1st, 2 is LDT 2nd, 4 is LST 1st, 6 is LST 2nd
...
#want to calculate area under the curve for 300 to 600 (so 450:750 including the first 150)
#subtract a constant so they are all negative
largest = max(apply(finaldata[ , 450:750], 1, max))
largest$area = apply(finaldata[ , 450:750], 1, function(x){trapz(300:600, as.numeric((x-largest)))})
```
